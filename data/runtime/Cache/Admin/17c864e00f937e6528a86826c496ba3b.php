...
<html>
	...
	<head>
		<meta charset="UTF-8" />
		<title>E酒店后台管理中心</title>
		<meta http-equiv="X-UA-Compatible" content="chrome=1,IE=edge" />
		<meta name="renderer" content="webkit|ie-comp|ie-stand">
		<meta name="robots" content="noindex,nofollow">
		<link href="/admin/themes/simplebootx/assets/css/admin_login.css" rel="stylesheet" />
		<style>
			#login_btn_wraper {
				text-align: center;
			}
	...
	<body>
		<div class="logo">
			<img src="/admin/themes/simplebootx/assets/images/logo.png" style="display: none;">
		</div>
		<div class="wrap">
			<div class="login">
				<h1>E酒店后台管理中心</h1>
		...
		<div class="copy">&copy; 2016 <a href="">E酒店</a>
		</div>
