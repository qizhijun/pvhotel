...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="javascript:;">房量修改</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Hotel/fledit_post');?>">
			<fieldset>
				...
				<div class="control-group">
					<label class="control-label">设置房量</label>
					<div class="controls">
						<input type="text" name="roomnum" value="" style="width:80px;">
						<span class="form-required">间(每天可售)</span>
					</div>
				</div>
			</fieldset>
