...
<html ng-app="HotelmApp" class="ng-scope">
	...
	<li>
		...
		<div id="main_main" ng-view="" class="ng-scope">
			<link href="/themes/simplebootx_wx/Public/css/frozen.css?v=0.0.1" rel="stylesheet" class="ng-scope">
		...
		<script>
			...
			$(function(){
				...
				$("#div_get_yzm").on("click",function(){
		            ...
		            $.post("<?php echo U('User/sendVcode');?>",{txt_tel:txt_tel},function(data){
		            	if(data.success == false){
		            		alert(data.message);
		            		return false;
		            	}else{
