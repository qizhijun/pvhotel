...
var mt_rate_meb = [
    { m: 1, r: 2, tag: "yk", name: "银卡（识君）", tips: "您是E酒店银会员（识君），享8.8折会员折扣" },
    { m: 2, r: 3, tag: "jk", name: "金卡（知己）", tips: "您是E酒店金会员（知己），享8.8折会员折扣" },
    { m: 3, r: 4, tag: "bj", name: "铂金卡（执手）", tips: "您是E酒店铂金员（执手），享8.8折会员折扣" },
    { m: 0, r: 100, tag: "notmeb", name: "首次预订", tips: "非会员E酒店官网自主预订，享8.8折房费折扣" },
    { m: 12, r: 3012, tag: "zxk", name: "业主尊享", tips: "您是E酒店业主尊享会员，享8折会员折扣" }];
...
//                  if (_datarate.RoomRateTypeID == 1) { rt_rate.mshi = _datarate.RoomRate; continue; }
                    rt_rate.notmeb =rt_rate.yk =rt_rate.jk =rt_rate.bj =rt_rate.zxk =rt_rate.mshi =_datarate.RoomRate;
        ...
        if ($(this).data("Init") == undefined) {
            ...
            $(this).data({ "Init": true });
            $(".tblcalendar>tbody>tr>td[endofday='" + serviceDate + "']").click();
        }
